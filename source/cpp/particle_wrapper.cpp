...
PYBIND11_MODULE(particle_wrapper, m)
{
  ...
  py::class_<dolfin::particles>(m, "particles")
      ...
      .def("increment", overload_cast_<
        ...
        (&dolfin::particles::increment), "increment",
        py::arg("psih_new"), py::arg("psih_old"), py::arg("slots"),
        py::arg("theta"), py::arg("step"))
      .def("increment", overload_cast_<
        const dolfin::Function&,
        Eigen::Ref<const Eigen::Array<std::size_t, Eigen::Dynamic, 1>>,
        const double, const std::size_t, const double>()
        (&dolfin::particles::increment), "increment",
        py::arg("d_psih"), py::arg("slots"),
        py::arg("theta"), py::arg("step"), py::arg("dt"))
  ...
  py::class_<dolfin::AssemblerStaticCondensation>(m, "AssemblerStaticCondensation")
      ...
      .def(py::init<std::shared_ptr<const dolfin::Form>,
                    ...
                    std::vector<std::shared_ptr<const dolfin::DirichletBC>>>())
      .def("assemble_global",
           &dolfin::AssemblerStaticCondensation::assemble_global)
      .def("assemble_global_lhs",
           &dolfin::AssemblerStaticCondensation::assemble_global_lhs)
      .def("assemble_global_rhs",
           &dolfin::AssemblerStaticCondensation::assemble_global_rhs)
      .def("assemble_global_system",
           &dolfin::AssemblerStaticCondensation::assemble_global_system)
      .def("backsubstitute", &dolfin::AssemblerStaticCondensation::backsubstitute);
